...
class SmartClassifier:
    ...
    def classify(self, win_info: dict[WindowInfo, Optional[str | int]]) -> AppType:
        ...
        prod_score += self._score_title(str(title), self.prod_keywords, self._prod_kw_regex)
        dist_score += self._score_title(str(title), self.dist_keywords, self._dist_kw_regex)
